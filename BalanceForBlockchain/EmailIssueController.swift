...
class EmailIssueController: NSViewController {
    ...
    override func loadView() {
        ...
        titleLabel.stringValue = "Submit Feedback"
        titleLabel.font = CurrentTheme.emailIssue.titleFont
...
//        if let plaidInstitution = plaidInstitution {
//            let institution = "\(plaidInstitution.name) (\(plaidInstitution.type))"
//            institutionLabel.attributedStringValue = attributedString(name: "Institution", value: institution)
//        }
        ...
        notesField.placeholderString = "Your feedback"
        ...
        messageLabel.stringValue = "We will follow up within 24 hours."
        ...
        backButton.font = CurrentTheme.emailIssue.buttonFont
        ...
        submitButton.font = CurrentTheme.emailIssue.buttonFont
    ...
    fileprivate func attributedString(name: String, value: String) -> NSAttributedString {
        let nameAttributes = [NSFontAttributeName: CurrentTheme.emailIssue.infoLabelNameFont,
                              NSForegroundColorAttributeName: CurrentTheme.emailIssue.infoLabelNameColor]
        let nameAttributedString = NSAttributedString(string: name + ": ", attributes: nameAttributes)
        
        let valueAttributes = [NSFontAttributeName: CurrentTheme.emailIssue.infoLabelValueFont,
                               NSForegroundColorAttributeName: CurrentTheme.emailIssue.infoLabelValueColor]
...
//        submitButton.isEnabled = false
//        
//        let isConnectionError = plaidErrorCode != nil && plaidInstitution != nil
//        plaidApi.emailFeedback(plaidErrorCode: plaidErrorCode, institutionType: plaidInstitution?.type, email: emailField.stringValue, comment: notesField.stringValue) { success, error in
//            AppDelegate.sharedInstance.pinned = true
//            if success {
//                let alert = NSAlert()
//                alert.addButton(withTitle: "OK")
//                alert.messageText = isConnectionError ? "Report Sent" : "Feedback Sent"
