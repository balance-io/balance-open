//
//  SearchFilterButtonsLight.swift
//  Balance
//
...
struct SearchFilterButtonsLight {
    ...
    static func drawButton(frame: NSRect = NSRect(x: 0, y: 0, width: 191, height: 36), buttonBackgroundColor: NSColor?) {
        ...
        //// Color Declarations
        let buttonBackground = buttonBackgroundColor ?? NSColor(deviceRed: 0.635, green: 0.682, blue: 0.722, alpha: 1)
        let buttonDarkBackground = NSColor(deviceRed: 0, green: 0, blue: 0, alpha: 0.1)
        let buttonBorderColor = NSColor(deviceRed: 0, green: 0, blue: 0, alpha: 0.06)
        let transparentBackground = NSColor(deviceRed: 0.867, green: 0.882, blue: 0.91, alpha: 0.06)
