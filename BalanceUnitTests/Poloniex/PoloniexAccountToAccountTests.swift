...
class PoloniexAccountToAccountTests: XCTestCase {
    ...
    func testCurrencyBalanceForSC() {
        ...
        //then
        XCTAssertEqual(account.available, Decimal(string: "26576.400000005")!)
    }
    ...
    func testCurrencyBalanceForBTC() {
        ...
        //then
        XCTAssertEqual(account.available, Decimal(string: "0.17786885")!)
    }
    ...
    func testCurrencyAltBalanceForSC() {
        ...
        //then
        XCTAssertEqual(account.btcValue, Decimal(string: "0.17786885")!)
    }
