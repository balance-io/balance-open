...
class SyncButton: View {
    ...
    fileprivate func setupMouseTrackingArea() {
        ...
        mouseTrackingArea = NSTrackingArea(rect: syncCircle.frame, options: [.activeInKeyWindow, .mouseEnteredAndExited], owner: self, userInfo: nil)
    ...
    override func mouseEntered(with event: NSEvent) {
        if mouseHandlingEnabled {
            overrideText = "Click to sync now"
        }
    }
